...
namespace ThisTianFaAndWuJingMod.Core
{
    internal abstract class BaseSwing : BaseHeldProj
    {
        ...
        public virtual void WarpDraw() {
            ...
            Effect effect = EffectLoader.KnifeRendering;
        ...
        public virtual void DrawTrail(List<VertexPositionColorTexture> bars) {
            Effect effect = TFAWMod.Instance.Assets.Request<Effect>(EffectLoader.AssetPath2 + "KnifeRendering").Value;
